...
<?php
  ...
  for ($i = 0; $i < $num; $i++) {
    ...
    $str .= "<a class='sub-item' href='https://www.bilibili.com/bangumi/play/ss$ss/' target='_blank'><div class='img-box'><img referrerPolicy='no-referrer' src='$cover@220w_280h.jpg' alt=''><span></span></div><div class='sub-info'><div class='name ellipsis'>$title</div><div class='desc ellipsis-2lines'>$evaluate</div><div class='channel'><span>$season_type_name </span><i>&nbsp;&nbsp;</i><span>$area</span></div><div class='progress'><span>$progress </span><i>&nbsp;&nbsp;</i><span>$index_show</span></div></div></a>";
  };
  $str = preg_replace('/\\n*/', '', $str);
